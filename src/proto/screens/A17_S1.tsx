...
export default function ScreenA17_S1() {
  const v = useVals();
  const insets = useSafeAreaInsets();
  return (
    <View style={s.s0}>
      <View style={[s.s1, { height: insets.top }]} />
      <AppHeader title="Incident submitted" showBack={false} />
      <ScrollView style={s.s2} contentContainerStyle={s.s3} showsVerticalScrollIndicator={false}>
        <View style={s.s4}>
          ...
          <Text style={s.s8}>
            Kate Ryan has been notified. Keep your phone on you, the safety team may call.
          </Text>
        </View>
